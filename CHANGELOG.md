...
- [#9](https://github.com/pedro-stanaka/thanos/pull/9): UI: Migrate the React app (`pkg/ui/react-app`) from npm to pnpm; contributors now need pnpm 11+ instead of npm to build the Web UI.
